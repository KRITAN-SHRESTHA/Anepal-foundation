    ...
    >
      ...
      <div className="relative z-10 mt-auto p-6">
        <div className="translate-y-8 transform opacity-0 transition-all duration-700 group-hover/bento:translate-y-0 group-hover/bento:opacity-100">
          <h3 className="text-shadow-accent-foreground/20 mb-2 text-3xl font-bold text-white text-shadow-sm">
            {title}
          </h3>
          {description && (
            <p className="text-shadow-accent-foreground/20 translate-y-4 transform text-sm font-normal text-white opacity-0 transition-all delay-100 duration-700 text-shadow-sm group-hover/bento:translate-y-0 group-hover/bento:opacity-100">
              {description}
            </p>
          )}
        </div>
