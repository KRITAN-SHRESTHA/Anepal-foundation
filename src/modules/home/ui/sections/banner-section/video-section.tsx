      ...
      <Dialog>
        <DialogTrigger>
          <div className="group relative flex h-[130px] w-[230px] cursor-pointer items-center justify-center overflow-hidden bg-purple-400">
            ...
            {/* Main button */}
            <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 shadow-lg transition-transform duration-500 group-hover:scale-110">
